...
def parser(inputMibs, mibSources, dstDirectory, dstFormat="json", genMibTextsFlag=True, ignoreErrorsFlag=True, pyCompileFlag=False, verboseFlag=False, mibSearchers=[], mibStubs=[], mibBorrowers=[]):
    # pyCompileFlag=False
    # dstDirectory=mib-json
    # dstFormat="json"
    # mibSources=mib-asn1
    ...
    # print(mibSources, mibBorrowers, mibSearchers, dstDirectory, mibStubs, inputMibs, dstFormat, dstTemplate, cacheDirectory, nodepsFlag, rebuildFlag, dryrunFlag, writeMibsFlag, buildIndexFlag, buildIndexFlag, genMibTextsFlag)
...
if __name__== '__main__':
    ...
    # print(f"mib source: {mibSources}, inputMibs= {inputMibs}, dstDirectory={dstDirectory}, dstFormat={dstFormat}")
